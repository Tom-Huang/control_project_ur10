...
int main(int argc, char** argv) {
    ...
    double cutoff;
    bool is_enabled;
    nh1.getParam("/filter_cutoff", cutoff);
    nh1.getParam("/enable_filter", is_enabled);
    ...
    if(is_enabled)
    {
        ...
        ros::Subscriber human_sub = nh1.subscribe<leap_motion::Human>("leap_device", 1, messageCallback);
        ros::Publisher f_pub = nh1.advertise<leap_motion::Human>("leap_filtered", 1);
        filt_pub = &f_pub;
